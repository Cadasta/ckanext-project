...
from ckanext.project.logic.validators import (convert_package_name_or_id_to_id_for_type_dataset,
                                               convert_package_name_or_id_to_id_for_type_project)


def project_base_schema():
    schema = {
        'id': [empty],
        'revision_id': [ignore],
...
def project_package_association_create_schema():
    schema = {
        'package_id': [not_empty, unicode, convert_package_name_or_id_to_id_for_type_dataset],
        'project_id': [not_empty, unicode, convert_package_name_or_id_to_id_for_type_project]
    }
    return schema


def project_package_association_delete_schema():
    return project_package_association_create_schema()


def project_package_list_schema():
    schema = {
        'project_id': [not_empty, unicode, convert_package_name_or_id_to_id_for_type_project]
    }
    return schema
...
def package_project_list_schema():
    schema = {
        'package_id': [not_empty, unicode, convert_package_name_or_id_to_id_for_type_dataset]
    }
    return schema
...
def project_admin_remove_schema():
    return project_admin_add_schema()
