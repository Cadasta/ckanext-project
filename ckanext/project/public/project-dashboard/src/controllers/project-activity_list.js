...
app.controller("activityCtrl", ['$scope', '$state', '$stateParams','dataService', 'utilityService', '$rootScope','cadastaProject', function($scope, $state, $stateParams, dataService, utilityService,$rootScope, cadastaProject){
    ...
    var promise = dataService.getAllActivities(cadastaProject.id);
